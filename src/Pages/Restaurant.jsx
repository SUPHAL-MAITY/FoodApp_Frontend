...
const Restaurant = () => {
  ...
  const getRestaurants = async () => {
    try {
      const { data } = await axios.get(
        `${import.meta.env.VITE_API}/api/restaurant/getresbyowner`
      );
  ...
  const handleClick = async (id) => {
    ...
    try {
      const { data } = await axios.get(
        `${import.meta.env.VITE_API}/api/restaurant/getsingle/${id}`
      );
      console.log(data);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `${import.meta.env.VITE_API}/api/restaurant/update/${id}`,
  ...
  const handleDelete = async (id) => {
    try {
      const { data } = await axios.delete(
        `${import.meta.env.VITE_API}/api/restaurant/delete/${id}`
      );
      if (data) {
    ...
    <>
      {count == 0 ? (
        <div className="mt-1 mb-2 p-2 text-center  font-serif text-xl font-extrabold bg-red-600 text-white">
          <h1>you have not added any Restaurant </h1>{" "}
        </div>
      ) : (
            ...
            >
              <div className="max-w-xs">
                <div className="bg-white shadow-xl rounded-lg py-3">
                  ...
                  <div className="p-2">
                    <h3 className="text-center text-xl text-gray-900 font-medium leading-8 font-serif">
                      {c.title}
                    </h3>
                    ...
                    <table className="text-xs my-3">
                      <tbody>
                        <tr>
                          <td className="px-2 py-2 text-gray-500 font-serif font-semibold">
                            Pick-Up
                          </td>
