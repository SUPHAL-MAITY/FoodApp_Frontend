  ...
  const handlePayment = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${import.meta.env.VITE_API}/api/food/order`,
        { cart }
      );
      if (data) {
      ...
      {!auth.token ? (
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            <h1 className="mb-4 font-serif text-5xl tracking-tight font-extrabold lg:text-6xl text-primary-600 dark:text-primary-500">
              Please Login to Check the Cart Page
            </h1>
        ...
        <section className="py-24 relative bg-blue-100">
          <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            <h2 className="title font-serif font-manrope font-bold text-4xl leading-10 mb-8 text-center text-black">
              Shopping Cart
            </h2>
                ...
                <div className="flex items-center flex-col min-[550px]:flex-row gap-2 min-[550px]:gap-6 w-full max-xl:justify-center max-xl:max-w-xl max-xl:mx-auto">
                  <div>
                    <img
                      src={c.imageUrl}
                      alt={c.title}
                      className="p-8 w-80 and h-64 rounded-t-lg"
                    />
                  </div>
                  <div className="pro-data w-full max-w-sm ">
                    <h5 className=" font-serif font-semibold text-xl leading-8 text-black max-[550px]:text-center">
                      {c.title}
                    </h5>
            ...
            <div className="bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
              ...
              <div className="flex items-center justify-between w-full py-6">
                ...
                <h6 className="font-manrope font-medium text-2xl leading-9 text-indigo-500">
                  ₹{allTotal >= 500 || allTotal == 0 ? allTotal : allTotal + 75}
                </h6>
              </div>
            </div>
