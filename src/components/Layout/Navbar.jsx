    ...
    <div>
      <header className="h-16  bg-gradient-to-r from-green-400 to-blue-500 sticky absolute hover:from-pink-500 hover:to-yellow-500  shadow-lg  hidden md:flex">
        <nav className="header-links  contents font-semibold text-base lg:text-lg">
          <ul className="flex  ml-4 xl:ml-8 mr-auto items-center">
            <li className="font-serif p-3 xl:p-6 active">
              <Link to="/">
                <span>Foodie Bar</span>
              </Link>
            </li>
          </ul>
              ...
              <li>
                <Dropdown
                  ...
                  renderTrigger={() => (
                    <span>
                      {auth?.user && (
                        <div className="mx-3  relative inline-flex items-center justify-center w-8 h-8 overflow-hidden bg-slate-300 rounded-full dark:bg-gray-600">
          ...
          <ul className="flex pt-2 items-center mr-4 lg:mr-6 xl:mr-8">
            <li className="p-1">
              <Link
                ...
                className="m-2 inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5"
              >
                <svg
                  className="h-4"
                  aria-hidden="true"
            ...
            <li className="p-1">
              <Link
                ...
                className="inline-block m-2 rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5"
              >
                <svg
                  className="h-4"
                  aria-hidden="true"
